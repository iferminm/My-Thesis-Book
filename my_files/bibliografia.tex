...
\bibitem{lucia} Cardoso, Lúcia. Sistemas de Base de Datos II, Teoría aplicada para profesores y estudiantes (2006). Caracas: Publicaciones UCAB.

\bibitem{papelLuque} Luque, M. et al. Caracterización Automática de Perfiles de Usuarios basados en Consultas Lingüísticas Multigranulares usando un Algoritmo Genético Multiobjetivo (S/F). España.
